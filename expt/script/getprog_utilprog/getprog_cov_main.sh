...
instru_utilprog/run_instru_gcccov.sh $BENCH $PROGNAME ${inputset}

#echo "Running fix_llvmcov_result.sh"
instru_utilprog/fix_llvmcov_result.sh $BENCH $PROGNAME ${inputset}_cov ${inputset}_gcccov

#echo "Running getprog_cov.sh"
getprog_utilprog/getprog_cov.sh $BENCH $PROGNAME ${inputset}
