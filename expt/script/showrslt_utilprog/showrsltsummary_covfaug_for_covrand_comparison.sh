...
inputid=$4
showinfo=$5
beta=$6      #gen is beta times as important as reduction


if [ -z $BENCH ] || [ -z $PROGNAME ] || [ -z ${progid} ] || [ -z ${inputid} ] || [ -z ${showinfo} ] || [ -z ${beta} ]; then
...
if [[ ${progid} == *covfaug* ]]; then    #Handle covfaug
