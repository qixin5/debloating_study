...
def train():
    ...
    #3
    train_run(""" --date 'March 1, 2015' "+%Y" """)
    
    #4
    train_run(""" --date 'March 1, 2015' "+%m" """)

    #5
    train_run(""" -d 'March 1, 2015' "+%d" """)
    
    #6
    train_run(""" --date 'March 1, 2015 +7 days' """)

    #7
    train_run(""" --date 'March 1, 2015 -1 year' """)
    
    #8
    train_run(""" --date 'March 1, 2015 +12 days +12 hours +15 minutes """)

    #9
    train_run(""" --date 'last Monday' """)
    
    #10
    train_run(""" --date 'next Monday' """)

    #11
    train_run(""" --date="March 1, 2018 +0 month" +'%B' """)
    
    #12
    train_run(""" --date="March 1, 2018 +0 month" +'%Y' """)

    #13
    train_run(""" --date="March 1, 2018 +1 month" +'%B' """)
    
    #14
    train_run(""" --date="March 1, 2018 +1 month" +'%Y' """)

    #15
    train_run(""" --date="March 31, 2018 +0 month" +'%B' """)
    
    #16
    train_run(""" --date="March 31, 2018 +0 month" +'%Y' """)

    #17
    train_run(""" --date="March 31, 2018 +1 month" +'%B' """)
    
    #18
    train_run(""" --date="March 31, 2018 +1 month" +'%Y' """)

    #19
    train_run(""" --date="March  1, 2018" '+%s' """)
    
    #20
    train_run(""" --date="March 31, 2018" '+%s' """)

    #21
    train_run(""" --date 'March 1, 2015 previous Monday' """)
