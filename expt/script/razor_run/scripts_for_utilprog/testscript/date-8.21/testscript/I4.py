...
def train():
    ...
    #1
    train_run(""" --date="12/2/2014" """)

    #2
    train_run(""" --date="2 Feb 2014" """)

    #3
    train_run(""" --date="Feb 2 2014" """)

    #4
    train_run(""" --date="Feb 2 2014 13:12:10" """)

    #5
    execute('echo "Sept 9 1986" >datefile')
    execute('echo "Aug 23 1987" >>datefile')
    train_run(""" --file=datefile """)
    execute('rm datefile')

    #6
    train_run(""" --date="next mon" """)
    ...
    #10
    train_run(""" --date='3 seconds ago' """)

    #11
    train_run(""" --date='1 day ago' """)

    #12
    train_run(""" --date='yesterday' """)

    #13
    train_run(""" --date='1 month ago' """)

    #14
    train_run(""" --date='1 year ago' """)

    #15
    train_run(""" -u """)

    #16
    execute('cp ' +indir+ 'datefile ./')
    train_run(""" -r datefile """)
    execute('rm datefile')
