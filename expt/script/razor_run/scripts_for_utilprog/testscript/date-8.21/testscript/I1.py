...
def train():
    ...
    #2
    train_run(""" --date="2/02/2010" """)

    #3
    train_run(""" --date="Feb 2 2010" """)

    #4
    train_run(""" --date="2 year ago" """)
    ...
    #7
    train_run(""" --date="2 month ago" """)
    
    #8
    train_run(""" --date="10 day ago" """)

    #9
    train_run(""" --date="next tue" """)
    ...
    #13
    execute('echo "Sep 23 2018" >datefile')
    execute('echo "Nov 03 2019" >>datefile')
