...
def train():
    ...
    #1
    train_run(""" -d "1974-01-04" """)

    #2
    train_run(""" +"Week number: %V Year: %y" """)
    ...
    #9
    train_run(""" -d last-sunday """)

    #10
    train_run(""" +%s """)

    #11
    train_run(""" -d "1974-01-04" +"%s" """)

    #12
    train_run(""" -d "UTC 1970-01-01 126507600 secs" """)

    #13
    train_run(""" -d @126507600 """)

    #14
    train_run(""" -d "1974-01-04" +"%A" """)
