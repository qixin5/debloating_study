...
def train():
    ...
    #1
    train_run(""" -d "next Tuesday" """)
    
    #2
    train_run(""" --date="Sun,  29  Feb  2004  16:21:42  -0800" """)

    #3
    train_run(""" --date="2004-02-29 16:21:42" """)
    
    #4
    train_run(""" --date="next Thursday" """)
