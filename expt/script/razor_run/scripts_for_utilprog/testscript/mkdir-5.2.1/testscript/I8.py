...
def train():
    ...
    train_run("", "memos letters e-mail")
    execute('rm -fr memos letters e-mail')

    train_run("-p", "/home/qxin6/tmp/customer/acme/foo/bar")
    execute('rm -fr /home/qxin6/tmp/customer')

    train_run("", "/home/baz")
    execute('rm -fr /home/baz')
    return
