...
def train():
    ...
    train_run("", "newdir")
    execute('rm -fr newdir')

    train_run("", "/tmp/newdir")
    execute('rm -fr /tmp/newdir')

    train_run("", "/root/newdir")
    execute('rm -fr /root/newdir')

    train_run("", "/home/qxin6/tmp/linuxize/Music/Rock/Gothic")
    execute('rm -fr /home/qxin6/tmp/linuxize')

    train_run("-p", "/home/qxin6/tmp/linuxize/Music/Rock/Gothic")
    execute('rm -fr /home/qxin6/tmp/linuxize')
    ...
    train_run("-m 700", "newdir")
    execute('rm -fr newdir')

    train_run("", "dir1 dir2 dir3")
    execute('rm -fr dir1 dir2 dir3')

    train_run("-p", "Music/{Jazz/Blues,Folk,Disco,Rock/{Gothic,Punk,Progressive},Classical/Baroque/Early}")
    execute('rm -fr Music')
    return
