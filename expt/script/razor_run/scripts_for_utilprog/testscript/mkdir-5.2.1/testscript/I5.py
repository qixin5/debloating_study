...
def train():
    ...
    train_run("-m a=rwx", "mydir")
    execute('rm -fr mydir')

    train_run("", "test1 test2 test3")
    execute('rm -fr test1 test2 test3')

    train_run("-p", "/home/qxin6/tmp/test/test1/test2/test3/test4")
    execute('rm -fr /home/qxin6/tmp/test')
    return
