...
def train():
    ...
    #0
    execute('cp -r ' +indir+ 'Pictures ./')
    train_run("""Pictures/529395.jpg""")
    execute('rm -fr Pictures')

    #1
    execute('cp -r ' +indir+ 'test.txt ./')
    train_run("""-v test.txt""")
    execute('rm -fr test.txt')

    #2
    execute('cp -r ' +indir+ 'hello.txt ./')
    train_run_with_echo("""-iv hello.txt""", 'y')
    execute('rm -fr hello.txt')
    ...
    train_run("""-Iv test1 test2 test3 test4""", 'y')
    execute('rm -fr test1 test2 test3 test4')
    ...
    #5
    execute('cp -r ' +indir+ 'files ./')
    train_run("""-rfv files/""")
    execute('rm -fr files')

    #6
    execute('cp -r ' +indir+ 'files ./')
    train_run_with_echo("""-rvi files/""", 'y')
    execute('rm -fr files')
