...
def train():
    ...
    #4
    execute('cp -r ' +indir+ 'test.png ./')
    train_run("""test.png""")
    execute('rm -fr test.png')
    ...
    execute('cp -r ' +indir+ 'file1 ./')
    execute('cp -r ' +indir+ 'file2 ./')
    train_run_with_echo("""-i file1 file2""", 'y')
    ...
    train_run("""-I file1 file2 file3 file4""", 'y')
    execute('rm -fr file1 file2 file3 file4')
