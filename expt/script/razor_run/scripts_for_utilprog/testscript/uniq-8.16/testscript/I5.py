...
def train():
    ...
    execute('cp ' +d+ 'file4 ./')
    execute('sort file4 >file4_sorted')
    train_run("-c", 'file4_sorted')
    execute('rm file4_sorted file4')
    
    train_run("-u", d + 'file5')

    train_run("-u", d + 'file5 output')
    execute('rm -fr output')

    train_run("-s 1", d + 'file6')
    return
