...
def train():
    ...
    train_run("", d + 'example.txt')

    execute('cp ' +d+ 'example.txt ./')
    execute('sort example.txt >example_sorted.txt')
    train_run("", 'example_sorted.txt')
    execute('rm example_sorted.txt example.txt')

    train_run("-c", d + 'example.txt')
    train_run("-d", d + 'example.txt')
    train_run("-D", d + 'example.txt')
    train_run("-f2", d + 'example.txt')
    train_run("-u", d + 'example.txt')
    return
