...
def train():
    ...
    train_run("-c", d + 'file1')
    train_run("-D", d + 'file2')
    train_run("--all-repeated=prepend", d + 'file2')
    train_run("-d", d + 'file2')
    train_run("-f 1", d + 'file3')
    train_run("-f1 --group=prepend", d + 'file3')
    train_run("-u", d + 'file3')
    train_run("-f1 -u", d + 'file3')
    train_run("-s 4", d + 'file4')
    train_run("-w 3", d + 'file4')
    train_run("-w 3 -i", d + 'file4')
    return
