...
def train():
    ...
    execute('cp ' +d+ 'namesd.txt ./')
    execute('sort namesd.txt >namesd_sorted.txt')
    train_run("", 'namesd_sorted.txt')
    execute('rm namesd_sorted.txt namesd.txt')

    execute('cp ' +d+ 'sorted_namesd.txt ./')
    train_run("-c", 'sorted_namesd.txt')
    execute('rm sorted_namesd.txt')

    execute('cp ' +d+ 'sorted_namesd.txt./')
    train_run("-cd", 'sorted_namesd.txt')
    execute('rm sorted_namesd.txt')
