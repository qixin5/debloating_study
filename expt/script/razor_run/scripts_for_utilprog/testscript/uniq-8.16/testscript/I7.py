...
def train():
    ...
    train_run("", d + 'goddess.txt')
    train_run("-i", d + 'goddess.txt')
    train_run("-c", d + 'goddess.txt')
    train_run("-i -c", d + 'goddess.txt')
    train_run("-u", d + 'goddess.txt')
    train_run("-d", d + 'goddess.txt')
    train_run("-D", d + 'goddess.txt')
    train_run("-f1", d + 'super.txt')
    train_run("-s1 -w2", d + 'goddess.txt')
    return
