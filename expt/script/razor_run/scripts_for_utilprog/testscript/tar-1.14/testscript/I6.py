...
def train():
    ...
    train_run("-cvf archiveToCreate.tar", 'file1 file2 file3')
    execute('rm -fr archiveToCreate.tar file1 file2 file3')
    
    #1
    execute('cp -r ' +indir+ 'dir ./')
    train_run("-cvf archiveToCreate.tar", './dir/*')
    execute('rm -fr archiveToCreate.tar ./dir')
    
    #2
    execute('cp -r ' +indir+ 'dir.tar ./')
    train_run("-xvf", 'dir.tar')
    execute('rm -fr dir.tar dir')
