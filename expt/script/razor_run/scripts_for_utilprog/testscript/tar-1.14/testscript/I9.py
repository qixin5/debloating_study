...
def train():
    ...
    train_run("-cf file.tar", 'file1 file2 file3')
    execute('rm -fr file.tar file1 file2 file3')
    
    #1
    execute('cp -r ' +indir+ 'file1 ./')
    execute('cp -r ' +indir+ 'file2 ./')
    execute('cp -r ' +indir+ 'file3 ./')    
    train_run("-cvf file.tar", 'file1 file2 file3')
    execute('rm -fr file.tar file1 file2 file3')
    
    #2
    execute('cp -r ' +indir+ 'dir1 ./')
    execute('cp -r ' +indir+ 'dir2 ./')    
    train_run("-cvf dir.tar", 'dir1 dir2')
    execute('rm -fr dir.tar dir1 dir2')
    ...
    execute('cp -r ' +indir+ 'dir1 ./')
    execute('cp -r ' +indir+ 'dir2 ./')
    train_run("-cf all.tar", 'file1 file2 file3 dir1 dir2')
    execute('rm -fr all.tar file1 file2 file3 dir1 dir2')
    
    #4
    execute('cp -r ' +indir+ 'file.tar ./')
    train_run("-xvf", 'file.tar')
    execute('rm -fr file.tar file1 file2 file3 file4 file5 file6')
    
    #5
    execute('cp -r ' +indir+ 'file.tar ./')
    execute('cp -r ' +indir+ 'file7 ./')
    train_run("-rf", 'file.tar file7')
    execute('rm -fr file.tar file7')
    
    #6
    execute('cp -r ' +indir+ 'file.tar ./')
    train_run("-f", 'file.tar --delete file1 file2')
    execute('rm -fr file.tar file1 file2')
