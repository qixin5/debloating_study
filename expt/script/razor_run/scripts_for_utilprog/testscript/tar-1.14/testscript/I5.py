...
def train():
    ...
    #0
    execute('cp -r ' +indir+ 'my-dir ./')
    train_run("-cf", 'my-dir.tar my-dir')
    execute('rm -fr my-dir.tar my-dir')
    
    #1
    execute('cp -r ' +indir+ 'my-file.txt ./')
    train_run("-cf", 'archive.tar my-file.txt')
    execute('rm -fr archive.tar my-file.txt')
    
    #2
    execute('cp -r ' +indir+ 'file.tar ./')
    train_run("-xf", 'file.tar')
    execute('rm -fr file.tar file')
    
    #3
    execute('cp -r ' +indir+ 'some_archive.tar ./')
    train_run("-xf", 'some_archive.tar -C .')
    execute('rm -fr some_archive.tar some_archive')
