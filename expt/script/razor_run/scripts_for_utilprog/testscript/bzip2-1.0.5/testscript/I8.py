...
def train():
    ...
    execute('rm file1 file1.bz2')
    execute('rm file2 file2.bz2')
    execute('rm file3 file3.bz2')

    #1
    execute('cp ' +d+ 'file1 ./')
    execute('cp ' +d+ 'file2 ./')
    execute('cp ' +d+ 'file3 ./')
    train_run("-v", 'file1 file2 file3')
    execute('rm file1 file1.bz2')
    execute('rm file2 file2.bz2')
    execute('rm file3 file3.bz2')
    
    #2
    execute('cp ' +d+ 'file7.tar ./')
    train_run("", 'file7.tar')
    execute('rm file7.tar file7.tar.bz2')
