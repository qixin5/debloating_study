...
def train():
    ...
    #0
    execute('cp ' +d+ 'input.txt ./')
    train_run("-z", 'input.txt')
    execute('rm input.txt input.txt.bz2')    

    #1
    execute('cp ' +d+ 'input.txt ./')
    train_run("-k", 'input.txt')
    execute('rm input.txt input.txt.bz2')

    #2
    execute('cp ' +d+ 'input.txt ./')
    execute('bzip2 input.txt')
    train_run("-d", 'input.txt.bz2')
    execute('rm input.txt input.txt.bz2')

    #3
    execute('cp ' +d+ 'input.txt ./')
    execute('bzip2 input.txt')
    train_run("-t", 'input.txt.bz2')
    execute('rm input.txt input.txt.bz2')

    #4
    execute('cp ' +d+ 'input.txt ./')
    train_run("-v", 'input.txt')
    execute('rm input.txt input.txt.bz2')
