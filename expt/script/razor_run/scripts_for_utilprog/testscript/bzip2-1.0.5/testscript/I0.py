...
def train():
    ...
    #0
    execute('cp ' +d+ 'list.txt ./')
    train_run("", 'list.txt')
    execute('rm list.txt')
    execute('rm list.txt.bz2')

    #1
    execute('cp ' +d+ 'list.txt ./')
    execute('cp ' +d+ 'list1.txt ./')
    execute('cp ' +d+ 'list2.txt ./')
    train_run("", 'list.txt list1.txt list2.txt')
    execute('rm list.txt list1.txt list2.txt')
    execute('rm list.txt.bz2 list1.txt.bz2 list2.txt.bz2')

    #2
    execute('cp ' +d+ 'list.txt ./')
    execute('bzip2 list.txt')
    train_run("-d", 'list.txt.bz2')
    execute('rm list.txt list.txt.bz2')
