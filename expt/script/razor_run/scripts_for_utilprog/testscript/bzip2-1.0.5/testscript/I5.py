...
def train():
    ...
    #0
    execute('cp ' +d+ 'myfile.txt ./')
    train_run("", 'myfile.txt')
    execute('rm myfile.txt myfile.txt.bz2')

    #1
    execute('cp ' +d+ 'myfile.txt ./')
    train_run("-c", 'myfile.txt >myfile.txt.bz2')
    execute('rm myfile.txt myfile.txt.bz2')

    #2
    execute('cp ' +d+ 'myfile.txt ./')
    train_run("-k", 'myfile.txt')
    execute('rm myfile.txt myfile.txt.bz2')

    #3
    execute('cp ' +d+ 'myfile.txt ./')
    execute('cp ' +d+ 'myfile1.txt ./')
    execute('cp ' +d+ 'myfile2.txt ./')
    execute('cp ' +d+ 'myfile3.txt ./')
    train_run("", 'myfile.txt myfile1.txt myfile2.txt myfile3.txt')
    execute('rm myfile.txt myfile.txt.bz2')
    execute('rm myfile1.txt myfile1.txt.bz2')
    execute('rm myfile2.txt myfile2.txt.bz2')
    execute('rm myfile3.txt myfile3.txt.bz2')

    #4
    execute('cp ' +d+ 'myfile.txt ./')
    execute('bzip2 myfile.txt')
    train_run("-t", 'myfile.txt.bz2')
    execute('rm myfile.txt myfile.txt.bz2')

    #5
    execute('touch myfile.txt.bz2')
    train_run("-t", 'myfile.txt.bz2')
    execute('rm myfile.txt.bz2')

    #6
    execute('cp ' +d+ 'myfile.txt ./')
    execute('bzip2 myfile.txt')
    train_run("-d", 'myfile.txt.bz2')
    execute('rm myfile.txt myfile.txt.bz2')
    ...
    #8
    execute('cp ' +d+ 'myfile.txt ./')
    train_run("-1", 'myfile.txt')
    execute('rm myfile.txt myfile.txt.bz2')
    
    #9
    execute('cp ' +d+ 'myfile.txt ./')
    train_run("-9", 'myfile.txt')
    execute('rm myfile.txt myfile.txt.bz2')
