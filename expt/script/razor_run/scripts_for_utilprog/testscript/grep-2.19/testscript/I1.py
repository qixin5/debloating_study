...
def train():
    ...
    train_run(""" "e*tools" ./dir0 """)
    execute('rm -fr dir0')

    #1
    execute('cp -r ' +indir+ '* ./')
    train_run(""" -r "hello" dir0 dir1 dir2 file0 """)
    execute('rm -fr dir0 dir1 dir2 file0')

    #2
    execute('cp -r ' +indir+ '* ./')
    train_run(""" -rl "hello" dir0 dir1 dir2 file0 """)
    execute('rm -fr dir0 dir1 dir2 file0')

    #3
    execute('cp -r ' +indir+ '* ./')
    execute('mv dir1 .git')
    train_run(""" -r --exclude-dir='.git' "hello" dir0 .git dir2 file0 """)
    execute('rm -fr dir0 .git dir2 file0')

    #4
    execute('cp -r ' +indir+ 'dir2 ./')
    train_run(""" -i ".*Legacy.*xml" ./dir2/0.java """)
    execute('rm -fr dir2')
