...
def train():
    ...
    #2
    execute('cp -r ' +indir+ 'samplefile ./')
    train_run(""" -i "is" samplefile """)
    execute('rm -fr samplefile')
    
    #3
    execute('cp -r ' +indir+ 'samplefile1 ./')
    train_run(""" -iw "is" samplefile1 """)
    execute('rm -fr samplefile1')
