...
def train():
    ...
    #0
    execute('cp -r ' +d+ 'examples.desktop ./')
    train_run("", 'examples.desktop')
    execute('rm -fr examples.desktop examples.desktop.gz')

    #1
    execute('cp -r ' +d+ 'examples.desktop ./')
    train_run("-f", 'examples.desktop')
    execute('rm -fr examples.desktop examples.desktop.gz')

    #2
    execute('cp -r ' +d+ 'examples.desktop ./')
    execute('gzip examples.desktop')
    train_run("-d", 'examples.desktop.gz')
    execute('rm -fr examples.desktop examples.desktop.gz')

    #3
    execute('cp -r ' +d+ 'examples.desktop ./')
    execute('gzip examples.desktop')
    train_run("-l", 'examples.desktop.gz')
    execute('rm -fr examples.desktop.gz examples.desktop')

    #4
    execute('cp -r ' +d+ 'examples.desktop ./')
    train_run("-v", 'examples.desktop')
    execute('rm -fr examples.desktop examples.desktop.gz')

    #5
    execute('cp -r ' +d+ 'home ./')
    train_run("-r", './home/examples')
    execute('rm -fr ./home')

    #6
    execute('cp -r ' +d+ 'example ./')
    train_run("-t", 'example')
    execute('rm -fr example example.gz')
