...
def train():
    ...
    #1
    execute('cp -r ' +d+ '* ./')
    train_run("-r", 'file1.txt file2.txt file3.txt file4.txt')
    execute('rm -fr file1.txt.gz file2.txt.gz file3.txt.gz file4.txt.gz file1.txt file2.txt file3.txt file4.txt')

    #2
    execute('cp -r ' +d+ 'file1.txt ./')
    execute('gzip file1.txt')
    train_run("-d", 'file1.txt.gz')
    execute('rm -fr file1.txt.gz file1.txt')

    #3
    execute('cp -r ' +d+ 'file1.txt ./')
    execute('gzip file1.txt')
    train_run("-l", 'file1.txt.gz')
    execute('rm -fr file1.txt file1.txt.gz')

    #4
    execute('cp -r ' +d+ 'file1.txt ./')
    train_run("-5", 'file1.txt')
    execute('rm -fr file1.txt file1.txt.gz')
