...
def train():
    ...
    #0
    execute('cp -r ' +indir+ 'table1.txt ./')
    train_run('-k2', 'table1.txt')
    execute('rm -fr table1.txt')

    #1
    execute('cp -r ' +indir+ 'table1.txt ./')
    train_run('-k3', 'table1.txt')
    execute('rm -fr table1.txt')

    #2
    execute('cp -r ' +indir+ 'table1.txt ./')
    train_run('-k5', 'table1.txt')
    execute('rm -fr table1.txt')

    #3
    execute('cp -r ' +indir+ 'table1.txt ./')
    train_run('-t, -k5', 'table1.txt')
    execute('rm -fr table1.txt')

    #4
    execute('cp -r ' +indir+ 'table1.txt ./')
    train_run('-r -t, -k5', 'table1.txt')
    execute('rm -fr table1.txt')

    #5
    execute('cp -r ' +indir+ 'table1.txt ./')
    train_run('-k6', 'table1.txt')
    execute('rm -fr table1.txt')

    #6
    execute('cp -r ' +indir+ 'ls_n.txt ./')
    train_run('-t, -k5', 'ls_n.txt')
    execute('rm -fr ls_n.txt')
