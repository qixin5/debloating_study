...
def train():
    ...
    #0
    execute('cp -r ' +indir+ 'testv0 ./')
    train_run('', 'testv0')
    execute('rm -fr testv0')

    #1
    execute('cp -r ' +indir+ 'testv1 ./')
    train_run('', 'testv1')
    execute('rm -fr testv1')
    ...
    #3
    execute('cp -r ' +indir+ 'testv2 ./')
    train_run('', 'testv2')
    execute('rm -fr testv2')
    ...
    #5
    execute('cp -r ' +indir+ 'etc_passwd.txt ./')
    train_run('-t: -k 3n', 'etc_passwd.txt')
    execute('rm -fr etc_passwd.txt')

    #6
    execute('cp -r ' +indir+ 'sort1.txt ./')
    execute('cp -r ' +indir+ 'sort2.txt ./')    
    train_run('', 'sort1.txt sort2.txt')
    execute('rm -fr sort1.txt sort2.txt')

    #7
    execute('cp -r ' +indir+ 'testv3 ./')
    train_run('-r', 'testv3')
    execute('rm -fr testv3')

    #8
    execute('cp -r ' +indir+ 'testv3 ./')
    train_run('-r -u', 'testv3')
    execute('rm -fr testv3')

    #9
    execute('cp -r ' +indir+ 'testv4 ./')
    train_run('-c', 'testv4')
    execute('rm -fr testv4')
