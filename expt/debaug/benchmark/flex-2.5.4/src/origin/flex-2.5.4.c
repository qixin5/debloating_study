...
{ 
  ...
  {
  tmp = strcmp((char const   *)prefix, "yy");
  }
  if (tmp) {
    if (C_plus_plus) {
      {
...
{ 
  ...
  if (printstats) {
    {
    fprintf((FILE * __restrict  )err, (char const   * __restrict  )"%s version %s usage statistics:\n",
            program_name, flex_version);
    fprintf((FILE * __restrict  )err, (char const   * __restrict  )"  scanner options: -");
    }
    if (C_plus_plus) {
      {
      _IO_putc('+', err);
    ...
    {
    fprintf((FILE * __restrict  )err, (char const   * __restrict  )" -C");
    }
    if (long_align) {
      {
      _IO_putc('a', err);
    ...
    if (did_outfilename) {
      {
      fprintf((FILE * __restrict  )err, (char const   * __restrict  )" -o%s", outfilename);
      }
    }
    if (skelname) {
      {
      fprintf((FILE * __restrict  )err, (char const   * __restrict  )" -S%s", skelname);
      }
    }
    {
    tmp___6 = strcmp((char const   *)prefix, "yy");
    }
    if (tmp___6) {
      {
      fprintf((FILE * __restrict  )err, (char const   * __restrict  )" -P%s", prefix);
      }
    }
    {
    _IO_putc('\n', err);
    fprintf((FILE * __restrict  )err, (char const   * __restrict  )"  %d/%d NFA states\n",
            lastnfa, current_mns);
    fprintf((FILE * __restrict  )err, (char const   * __restrict  )"  %d/%d DFA states (%d words)\n",
            lastdfa, current_max_dfas, totnst);
    fprintf((FILE * __restrict  )err, (char const   * __restrict  )"  %d rules\n",
            (num_rules + num_eof_rules) - 1);
    }
    if (num_backing_up == 0) {
      {
      fprintf((FILE * __restrict  )err, (char const   * __restrict  )"  No backing up\n");
      }
    } else { //Added block
    if (fullspd) {
      {
      fprintf((FILE * __restrict  )err, (char const   * __restrict  )"  %d backing-up (non-accepting) states\n",
              num_backing_up);
      }
    } else { //Added block
    if (fulltbl) {
      ...
      {
      fprintf((FILE * __restrict  )err, (char const   * __restrict  )"  Compressed tables always back-up\n");
      }
    }
    }
    }
    if (bol_needed) {
      {
      fprintf((FILE * __restrict  )err, (char const   * __restrict  )"  Beginning-of-line patterns used\n");
      }
    }
    {
    fprintf((FILE * __restrict  )err, (char const   * __restrict  )"  %d/%d start conditions\n",
            lastsc, current_max_scs);
    fprintf((FILE * __restrict  )err, (char const   * __restrict  )"  %d epsilon states, %d double epsilon states\n",
            numeps, eps2);
    }
    if (lastccl == 0) {
      {
      fprintf((FILE * __restrict  )err, (char const   * __restrict  )"  no character classes\n");
      }
    } else {
      {
      fprintf((FILE * __restrict  )err, (char const   * __restrict  )"  %d/%d character classes needed %d/%d words of storage, %d reused\n",
              lastccl, current_maxccls, *(cclmap + lastccl) + *(ccllen + lastccl),
              current_max_ccl_tbl_size, cclreuse);
      }
    }
    {
    fprintf((FILE * __restrict  )err, (char const   * __restrict  )"  %d state/nextstate pairs created\n",
            numsnpairs);
    fprintf((FILE * __restrict  )err, (char const   * __restrict  )"  %d/%d unique/duplicate transitions\n",
            numuniq, numdup);
    }
    if (fulltbl) {
      {
      tblsiz = lastdfa * numecs;
      fprintf((FILE * __restrict  )err, (char const   * __restrict  )"  %d table entries\n",
              tblsiz);
      }
    } else {
      {
      tblsiz = 2 * (lastdfa + numtemps) + 2 * tblend;
      fprintf((FILE * __restrict  )err, (char const   * __restrict  )"  %d/%d base-def entries created\n",
              lastdfa + numtemps, current_max_dfas);
      fprintf((FILE * __restrict  )err, (char const   * __restrict  )"  %d/%d (peak %d) nxt-chk entries created\n",
              tblend, current_max_xpairs, peakpairs);
      fprintf((FILE * __restrict  )err, (char const   * __restrict  )"  %d/%d (peak %d) template nxt-chk entries created\n",
              numtemps * nummecs, current_max_template_xpairs, numtemps * numecs);
      fprintf((FILE * __restrict  )err, (char const   * __restrict  )"  %d empty table entries\n",
              nummt);
      fprintf((FILE * __restrict  )err, (char const   * __restrict  )"  %d protos created\n",
              numprots);
      fprintf((FILE * __restrict  )err, (char const   * __restrict  )"  %d templates created, %d uses\n",
              numtemps, tmpuses);
      }
    }
    if (useecs) {
      {
      tblsiz += csize;
      fprintf((FILE * __restrict  )err, (char const   * __restrict  )"  %d/%d equivalence classes created\n",
              numecs, csize);
      }
    }
    if (usemecs) {
      {
      tblsiz += numecs;
      fprintf((FILE * __restrict  )err, (char const   * __restrict  )"  %d/%d meta-equivalence classes created\n",
              nummecs, csize);
      }
    }
    {
    fprintf((FILE * __restrict  )err, (char const   * __restrict  )"  %d (%d saved) hash collisions, %d DFAs equal\n",
            hshcol, hshsave, dfaeql);
    fprintf((FILE * __restrict  )err, (char const   * __restrict  )"  %d sets of reallocations needed\n",
            num_reallocs);
    fprintf((FILE * __restrict  )err, (char const   * __restrict  )"  %d total table entries needed\n",
            tblsiz);
    }
  }
  {
...
{ 
  ...
  *(action_array + 0) = (char )'\000';
  ...
  while (1) {
    ...
    if ((int )*(arg + 1) == 45) {
      {
      tmp___3 = strcmp((char const   *)arg, "--help");
      }
      if (tmp___3) {
        {
        tmp___2 = strcmp((char const   *)arg, "--version");
        }
        if (tmp___2) {
          {
    ...
    while (1) {
      ...
      {
      fprintf((FILE * __restrict  )err, (char const   * __restrict  )"%s: unknown flag \'%c\'.  For usage, try\n\t%s --help\n",
...
{ 
  ...
  if (performance_report > 0) {
    if (lex_compat) {
      {
      fprintf((FILE * __restrict  )err, (char const   * __restrict  )"-l AT&T lex compatibility option entails a large performance penalty\n");
      fprintf((FILE * __restrict  )err, (char const   * __restrict  )" and may be the actual source of other reported performance penalties\n");
      }
    } else { //Added block
    if (do_yylineno) {
      {
      fprintf((FILE * __restrict  )err, (char const   * __restrict  )"%%option yylineno entails a large performance penalty\n");
      }
    }
    }
    if (performance_report > 1) {
      if (interactive) {
        {
        fprintf((FILE * __restrict  )err, (char const   * __restrict  )"-I (interactive) entails a minor performance penalty\n");
        }
      }
      if (yymore_used) {
        {
        fprintf((FILE * __restrict  )err, (char const   * __restrict  )"yymore() entails a minor performance penalty\n");
        }
      }
    }
    if (reject) {
      {
      fprintf((FILE * __restrict  )err, (char const   * __restrict  )"REJECT entails a large performance penalty\n");
      }
    }
    if (variable_trailing_context_rules) {
      {
      fprintf((FILE * __restrict  )err, (char const   * __restrict  )"Variable trailing context rules entail a large performance penalty\n");
      }
    }
  }
  if (reject) {
...
{ 
  ...
  {
  {
  fprintf((FILE * __restrict  )err, (char const   * __restrict  )"%s [-bcdfhilnpstvwBFILTV78+? -C[aefFmr] -ooutput -Pprefix -Sskeleton]\n",
          program_name);
  fprintf((FILE * __restrict  )err, (char const   * __restrict  )"\t[--help --version] [file ...]\n");
  fprintf((FILE * __restrict  )err, (char const   * __restrict  )"\t-b  generate backing-up information to %s\n",
          backing_name);
  fprintf((FILE * __restrict  )err, (char const   * __restrict  )"\t-c  do-nothing POSIX option\n");
  fprintf((FILE * __restrict  )err, (char const   * __restrict  )"\t-d  turn on debug mode in generated scanner\n");
  fprintf((FILE * __restrict  )err, (char const   * __restrict  )"\t-f  generate fast, large scanner\n");
  fprintf((FILE * __restrict  )err, (char const   * __restrict  )"\t-h  produce this help message\n");
  fprintf((FILE * __restrict  )err, (char const   * __restrict  )"\t-i  generate case-insensitive scanner\n");
  fprintf((FILE * __restrict  )err, (char const   * __restrict  )"\t-l  maximal compatibility with original lex\n");
  fprintf((FILE * __restrict  )err, (char const   * __restrict  )"\t-n  do-nothing POSIX option\n");
  fprintf((FILE * __restrict  )err, (char const   * __restrict  )"\t-p  generate performance report to err\n");
  fprintf((FILE * __restrict  )err, (char const   * __restrict  )"\t-s  suppress default rule to ECHO unmatched text\n");
  }
  if (! did_outfilename) {
    if (C_plus_plus) {
      tmp = "cc";
  ...
  {
  fprintf((FILE * __restrict  )err, (char const   * __restrict  )"\t-t  write generated scanner on stdout instead of %s\n",
          outfilename);
  fprintf((FILE * __restrict  )err, (char const   * __restrict  )"\t-v  write summary of scanner statistics to f\n");
  fprintf((FILE * __restrict  )err, (char const   * __restrict  )"\t-w  do not generate warnings\n");
  fprintf((FILE * __restrict  )err, (char const   * __restrict  )"\t-B  generate batch scanner (opposite of -I)\n");
  fprintf((FILE * __restrict  )err, (char const   * __restrict  )"\t-F  use alternative fast scanner representation\n");
  fprintf((FILE * __restrict  )err, (char const   * __restrict  )"\t-I  generate interactive scanner (opposite of -B)\n");
  fprintf((FILE * __restrict  )err, (char const   * __restrict  )"\t-L  suppress #line directives in scanner\n");
  fprintf((FILE * __restrict  )err, (char const   * __restrict  )"\t-T  %s should run in trace mode\n",
          program_name);
  fprintf((FILE * __restrict  )err, (char const   * __restrict  )"\t-V  report %s version\n",
          program_name);
  fprintf((FILE * __restrict  )err, (char const   * __restrict  )"\t-7  generate 7-bit scanner\n");
  fprintf((FILE * __restrict  )err, (char const   * __restrict  )"\t-8  generate 8-bit scanner\n");
  fprintf((FILE * __restrict  )err, (char const   * __restrict  )"\t-+  generate C++ scanner class\n");
  fprintf((FILE * __restrict  )err, (char const   * __restrict  )"\t-?  produce this help message\n");
  fprintf((FILE * __restrict  )err, (char const   * __restrict  )"\t-C  specify degree of table compression (default is -Cem):\n");
  fprintf((FILE * __restrict  )err, (char const   * __restrict  )"\t\t-Ca  trade off larger tables for better memory alignment\n");
  fprintf((FILE * __restrict  )err, (char const   * __restrict  )"\t\t-Ce  construct equivalence classes\n");
  fprintf((FILE * __restrict  )err, (char const   * __restrict  )"\t\t-Cf  do not compress scanner tables; use -f representation\n");
  fprintf((FILE * __restrict  )err, (char const   * __restrict  )"\t\t-CF  do not compress scanner tables; use -F representation\n");
  fprintf((FILE * __restrict  )err, (char const   * __restrict  )"\t\t-Cm  construct meta-equivalence classes\n");
  fprintf((FILE * __restrict  )err, (char const   * __restrict  )"\t\t-Cr  use read() instead of stdio for scanner input\n");
  fprintf((FILE * __restrict  )err, (char const   * __restrict  )"\t-o  specify output filename\n");
  fprintf((FILE * __restrict  )err, (char const   * __restrict  )"\t-P  specify scanner prefix other than \"yy\"\n");
  fprintf((FILE * __restrict  )err, (char const   * __restrict  )"\t-S  specify skeleton file\n");
  fprintf((FILE * __restrict  )err, (char const   * __restrict  )"\t--help     produce this help message\n");
  fprintf((FILE * __restrict  )err, (char const   * __restrict  )"\t--version  report %s version\n",
          program_name);
  }
  return;
}
...
{ 
  ...
  while (1) {
    ...
    if (trace) {
      {
      fprintf((FILE * __restrict  )err, (char const   * __restrict  )"state # %d:\n",
              ds);
      }
    }
    {
    ...
    while (1) {
      ...
      if (symlist[sym]) {
        ...
        if (duplist[sym] == 0) {
          ...
          if (trace) {
            {
            fprintf((FILE * __restrict  )err, (char const   * __restrict  )"\t%d\t%d\n",
                    sym, newds);
            }
          }
          targptr ++;
  ...
  if (trace) {
    ...
    while (1) {
      ...
      while (1) {
        ...
        fprintf((FILE * __restrict  )err, (char const   * __restrict  )"%4s = %-2d",
...
{ 
  ...
  while (1) {
    ...
    if (trace) {
      if (anum) {
        {
        fprintf((FILE * __restrict  )err, (char const   * __restrict  )"state # %d accepts: [%d]\n",
                i___0, anum);
        }
      }
    }
    ...
    while (1) {
      ...
      *(acc_array + i___0) = j;
      if (*(accsiz + i___0) != 0) {
        ...
        if (trace) {
          {
          fprintf((FILE * __restrict  )err, (char const   * __restrict  )"state # %d accepts: ",
                  i___0);
          }
        }
        k = 1;
        ...
        while (1) {
          ...
          if (trace) {
            {
            fprintf((FILE * __restrict  )err, (char const   * __restrict  )"[%d]",
                    *(accset + k));
            }
            if (k < nacc) {
              {
              fputs((char const   * __restrict  )", ", (FILE * __restrict  )err);
              }
            } else {
              {
              _IO_putc('\n', err);
...
{ 
  ...
  {
  {
  fprintf((FILE * __restrict  )err, (char const   * __restrict  )"%s: %s\n", program_name,
          msg);
  flexend(1);
  }
  return;
...
{ 
  ...
  {
  {
  fprintf((FILE * __restrict  )err, (char const   * __restrict  )"%s: fatal internal error, %s\n",
          program_name, msg);
  exit(1);
  }
}
...
{ 
  ...
  if (c >= 127) {
    ...
    switch_default: /* CIL Label */ 
    {
    sprintf((char * __restrict  )(rform), (char const   * __restrict  )"\\%.3o", (unsigned int )c);
    }
    return (rform);
    switch_break: /* CIL Label */ ;
    }
...
{ 
  ...
  while (1) {
    ...
    if (skelfile) {
      {
      tmp = fgets((char * __restrict  )buf, 2048, (FILE * __restrict  )skelfile);
      tmp___1 = (unsigned long )tmp != (unsigned long )((void *)0);
      }
    } else {
      tmp___0 = skel_ind;
      skel_ind ++;
...
{ 
  ...
  {
  {
  fprintf((FILE * __restrict  )err, (char const   * __restrict  )"\n\n********** beginning dump of nfa with start state %d\n",
          state1);
  ns = 1;
  }
  {
  while (1) {
    ...
    {
    fprintf((FILE * __restrict  )err, (char const   * __restrict  )"state # %4d\t",
            ns);
    sym = *(transchar + ns);
    tsp1 = *(trans1 + ns);
    tsp2 = *(trans2 + ns);
    anum = *(accptnum + ns);
    fprintf((FILE * __restrict  )err, (char const   * __restrict  )"%3d:  %4d, %4d",
            sym, tsp1, tsp2);
    }
    if (anum != 0) {
      {
      fprintf((FILE * __restrict  )err, (char const   * __restrict  )"  [%d]", anum);
      }
    }
    {
    fprintf((FILE * __restrict  )err, (char const   * __restrict  )"\n");
  ...
  {
  fprintf((FILE * __restrict  )err, (char const   * __restrict  )"********** end of dump\n");
  }
  return;
}
}
  ...
  *(rule_linenum + num_rules) = linenum;
  ...
  if (variable_trail_rule___0) {
    *(rule_type + num_rules) = 1;
    if (performance_report > 0) {
      {
      fprintf((FILE * __restrict  )err, (char const   * __restrict  )"Variable trailing context rule at line %d\n",
              *(rule_linenum + num_rules));
      }
    }
...
{ 
  ...
  if (trace) {
    if (beglin) {
      {
      fprintf((FILE * __restrict  )err, (char const   * __restrict  )"%d\t", num_rules + 1);
      beglin = 0;
      }
    }
    {
    ...
    case_260: /* CIL Label */ 
    {
    fputs((char const   * __restrict  )"%s", (FILE * __restrict  )err);
    }
    goto switch_break;
    case_261: /* CIL Label */ 
    {
    fputs((char const   * __restrict  )"%x", (FILE * __restrict  )err);
    }
    goto switch_break;
    case_259: /* CIL Label */ 
    {
    ...
    case_262: /* CIL Label */ 
    {
    fprintf((FILE * __restrict  )err, (char const   * __restrict  )"\'%s\'", nmstr);
    }
    goto switch_break;
    case_257: /* CIL Label */ 
    {
    ...
    {
    fprintf((FILE * __restrict  )err, (char const   * __restrict  )"\\%c", yylval);
    }
    goto switch_break___0;
    switch_default: /* CIL Label */ 
    if (! ((yylval & -128) == 0)) {
      {
      fprintf((FILE * __restrict  )err, (char const   * __restrict  )"\\%.3o", (unsigned int )yylval);
      }
    } else {
      {
      tmp = __ctype_b_loc();
    ...
    case_258: /* CIL Label */ 
    {
    fprintf((FILE * __restrict  )err, (char const   * __restrict  )"%d", yylval);
    }
    goto switch_break;
    case_263: /* CIL Label */ 
    {
    ...
    case_264: /* CIL Label */ 
    {
    fprintf((FILE * __restrict  )err, (char const   * __restrict  )"<<EOF>>");
    }
    goto switch_break;
    case_265: /* CIL Label */ 
    {
    fprintf((FILE * __restrict  )err, (char const   * __restrict  )"%s ", yytext);
    }
    goto switch_break;
    case_266: /* CIL Label */ 
    case_267: /* CIL Label */ 
    ...
    case_0: /* CIL Label */ 
    {
    fprintf((FILE * __restrict  )err, (char const   * __restrict  )"End Marker\n");
    }
    goto switch_break;
    switch_default___0: /* CIL Label */ 
    {
    fprintf((FILE * __restrict  )err, (char const   * __restrict  )"*Something Weird* - tok: %d val: %d\n",
            toktype, yylval);
    }
    goto switch_break;
    switch_break: /* CIL Label */ ;
...
{ 
  ...
  *yyvsp = yylval;
  ...
  if (*(transchar + *(lastst + *(yyvsp + 0))) != 257) {
    {
    tmp___2 = mkstate(257);
    *(yyvsp + 0) = link_machines(*(yyvsp + 0), tmp___2);
    }
  }
  {
  ...
  if (*(yyvsp + -3) == 0) {
    if (*(yyvsp + -1) <= 0) {
      ...
      {
      tmp___5 = mkrep(*(yyvsp + -5), 1, *(yyvsp + -1));
      yyval = mkopt(tmp___5);
      }
    }
  } else {
  ...
  if (caseins) {
    if (*(yyvsp + 0) >= 65) {
      if (*(yyvsp + 0) <= 90) {
        {
        tmp___11 = clower(*(yyvsp + 0));
        *(yyvsp + 0) = (int )tmp___11;
        }
      }
    }
  }
  ...
  while (1) {
    ...
    if ((c___0 & -128) == 0) {
      ...
      if ((int const   )*(*tmp___14 + c___0) & 1024) {
        {
  ...
  while (1) {
    ...
    if ((c___3 & -128) == 0) {
      ...
      if ((int const   )*(*tmp___16 + c___3) & 2048) {
        {
  ...
  while (1) {
    ...
    if ((c___4 & -128) == 0) {
      ...
      if ((int const   )*(*tmp___17 + c___4) & 32768) {
        {
  ...
  while (1) {
    ...
    if ((c___6 & -128) == 0) {
      ...
      if ((int const   )*(*tmp___19 + c___6) & 16384) {
        {
  ...
  if (caseins) {
    ...
    while (1) {
      ...
      if ((c___9 & -128) == 0) {
        ...
        if ((int const   )*(*tmp___22 + c___9) & 512) {
          {
  ...
  if (caseins) {
    if (*(yyvsp + 0) >= 65) {
      if (*(yyvsp + 0) <= 90) {
        {
        tmp___25 = clower(*(yyvsp + 0));
        *(yyvsp + 0) = (int )tmp___25;
        }
      }
    }
  }
...
{ 
  ...
  {
  {
  fprintf((FILE * __restrict  )err, (char const   * __restrict  )"%s\n", msg);
  exit(2);
  }
}
}
